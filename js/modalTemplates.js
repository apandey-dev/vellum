...
export const modalTemplates = {
    ...
    manageFolders: () => `
        ...
        <div class="modal-footer-compact">
            <div class="create-folder-form">
                ...
                <button class="form-btn primary create-folder-btn" id="createFolderBtn">Create</button>
            </div>
        </div>
    `,
    ...
    shareNote: () => `
        ...
        <div class="share-link-section" id="shareLinkSection">
            ...
            <div class="link-input-wrapper">
                ...
                <button class="copy-btn" id="copyLinkBtn" data-tooltip="Copy">Copy</button>
            </div>
            <p class="share-info">Anyone with this link can view this note for 24 hours.</p>
        </div>
    ...
    moveNote: (noteTitle) => `
        ...
        <div class="move-content">
            ...
            <div class="form-group">
                <label>Create & Move to New Folder</label>
                <div class="input-with-btn">
                    <input type="text" id="moveNewFolderName" placeholder="New folder name...">
                    <button class="form-btn primary" id="createAndMoveBtn">Create</button>
                </div>
            </div>
        </div>
    `
